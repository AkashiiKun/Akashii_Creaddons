...
public class LiquidBurnerFuelJsonLoader implements ResourceManagerReloadListener {
    public static final Identifier IDENTIFIER = Identifier.fromNamespaceAndPath(CreaddonMod.MOD_ID, "drainable_fuel_loader");
    private static final FileToIdConverter JSON_LISTER = FileToIdConverter.json("fuels");
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
        ...
        CreaddonMod.LOGGER.info("Loaded {} liquid burner fuels", BurnerStomachHandler.LIQUID_BURNER_FUEL_MAP.size());
    }
